...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Molienda</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class MoliendaImpl extends MinimalEObjectImpl.Container implements Molienda {
	/**
	...
	protected EClass eStaticClass() {
		return CoffeeModelingPackage.Literals.MOLIENDA;
	}
	...
	public void setRefMaquinaria(String newRefMaquinaria) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoffeeModelingPackage.MOLIENDA__REF_MAQUINARIA, oldRefMaquinaria, refMaquinaria));
	}
	...
	public void setFechaUltimoMantenimiento(String newFechaUltimoMantenimiento) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoffeeModelingPackage.MOLIENDA__FECHA_ULTIMO_MANTENIMIENTO, oldFechaUltimoMantenimiento, fechaUltimoMantenimiento));
	}
