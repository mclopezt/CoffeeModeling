...
/**
 * This is the item provider adapter for a {@link CoffeeModeling.Agua} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AguaItemProvider 
	 ...
	 * @generated
	 */
	public AguaItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Agua_tipo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Agua_tipo_feature", "_UI_Agua_type"),
				 CoffeeModelingPackage.Literals.AGUA__TIPO,
				 true,
				 false,
				 false,
	...
	protected void addCantidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Agua_cantidad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Agua_cantidad_feature", "_UI_Agua_type"),
				 CoffeeModelingPackage.Literals.AGUA__CANTIDAD,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Agua"));
	}
	...
	public String getText(Object object) {
		String label = ((Agua)object).getTipo();
		return label == null || label.length() == 0 ?
			getString("_UI_Agua_type") :
			getString("_UI_Agua_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Agua.class)) {
