...
/**
 * This is the item provider adapter for a {@link CoffeeModeling.Finca} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FincaItemProvider 
	 ...
	 * @generated
	 */
	public FincaItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Finca_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Finca_nombre_feature", "_UI_Finca_type"),
				 CoffeeModelingPackage.Literals.FINCA__NOMBRE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Finca"));
	}
	...
	public String getText(Object object) {
		String label = ((Finca)object).getNombre();
		return label == null || label.length() == 0 ?
			getString("_UI_Finca_type") :
			getString("_UI_Finca_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Finca.class)) {
